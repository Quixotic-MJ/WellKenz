...
-- Insert 150+ items with is_perishable flag
INSERT INTO items (item_code, name, description, category_id, unit_id, item_type, min_stock_level, max_stock_level, reorder_point, cost_price, selling_price, shelf_life_days, is_perishable, is_active) VALUES

-- Flour & Grains (High Volume - High Reorder Points)
('FLR001', 'All-Purpose Flour', 'Premium all-purpose wheat flour', 1, 1, 'raw_material', 50.000, 500.000, 150.000, 45.00, 0.00, 365, true, true),
('FLR002', 'Bread Flour', 'High protein bread flour', 1, 1, 'raw_material', 30.000, 300.000, 100.000, 52.00, 0.00, 365, true, true),
('FLR003', 'Cake Flour', 'Fine cake flour for pastries', 1, 1, 'raw_material', 20.000, 200.000, 60.000, 48.00, 0.00, 365, true, true),
('FLR004', 'Whole Wheat Flour', 'Organic whole wheat flour', 1, 1, 'raw_material', 15.000, 150.000, 45.000, 65.00, 0.00, 180, true, true),
('FLR005', 'Rye Flour', 'Dark rye flour for specialty bread', 1, 1, 'raw_material', 10.000, 100.000, 30.000, 75.00, 0.00, 180, true, true),
('FLR006', 'Corn Starch', 'Pure corn starch', 1, 1, 'raw_material', 5.000, 50.000, 15.000, 40.00, 0.00, 730, true, true),
('FLR007', 'Rice Flour', 'Gluten-free rice flour', 1, 1, 'raw_material', 8.000, 80.000, 25.000, 55.00, 0.00, 365, true, true),
('FLR008', 'Oat Flour', 'Healthy oat flour', 1, 1, 'raw_material', 12.000, 120.000, 35.000, 60.00, 0.00, 180, true, true),
('FLR009', 'Semolina', 'Durum wheat semolina', 1, 1, 'raw_material', 8.000, 80.000, 25.000, 58.00, 0.00, 365, true, true),
('FLR010', 'Buckwheat Flour', 'Gluten-free buckwheat flour', 1, 1, 'raw_material', 5.000, 50.000, 15.000, 85.00, 0.00, 180, true, true),

-- Dairy Products (Perishable - Strict Reorder Points)
('DRY001', 'Fresh Milk', 'Full cream fresh milk', 2, 5, 'raw_material', 20.000, 200.000, 60.000, 65.00, 0.00, 7, true, true),
('DRY002', 'Butter Unsalted', 'Premium unsalted butter', 2, 1, 'raw_material', 15.000, 150.000, 45.000, 320.00, 0.00, 30, true, true),
('DRY003', 'Butter Salted', 'Salted butter for cooking', 2, 1, 'raw_material', 10.000, 100.000, 30.000, 310.00, 0.00, 30, true, true),
('DRY004', 'Heavy Cream', '35% fat heavy cream', 2, 5, 'raw_material', 8.000, 80.000, 25.000, 180.00, 0.00, 14, true, true),
('DRY005', 'Cream Cheese', 'Philadelphia style cream cheese', 2, 1, 'raw_material', 12.000, 120.000, 35.000, 280.00, 0.00, 21, true, true),
('DRY006', 'Yogurt Plain', 'Natural plain yogurt', 2, 5, 'raw_material', 15.000, 150.000, 45.000, 95.00, 0.00, 14, true, true),
('DRY007', 'Buttermilk', 'Cultured buttermilk', 2, 5, 'raw_material', 8.000, 80.000, 25.000, 75.00, 0.00, 14, true, true),
('DRY008', 'Mozzarella Cheese', 'Shredded mozzarella cheese', 2, 1, 'raw_material', 10.000, 100.000, 30.000, 340.00, 0.00, 21, true, true),

-- Sweeteners (High Usage - High Reorder Points)
('SWT001', 'White Sugar', 'Refined white sugar', 3, 1, 'raw_material', 40.000, 400.000, 120.000, 55.00, 0.00, 730, true, true),
('SWT002', 'Brown Sugar', 'Dark brown sugar', 3, 1, 'raw_material', 20.000, 200.000, 60.000, 65.00, 0.00, 365, true, true),
('SWT003', 'Powdered Sugar', 'Confectioners sugar', 3, 1, 'raw_material', 15.000, 150.000, 45.000, 70.00, 0.00, 365, true, true),
('SWT004', 'Honey', 'Pure natural honey', 3, 5, 'raw_material', 8.000, 80.000, 25.000, 250.00, 0.00, 365, true, true),
('SWT005', 'Maple Syrup', 'Grade A maple syrup', 3, 5, 'raw_material', 5.000, 50.000, 15.000, 450.00, 0.00, 365, true, true),
('SWT006', 'Corn Syrup', 'Light corn syrup', 3, 5, 'raw_material', 10.000, 100.000, 30.000, 120.00, 0.00, 365, true, true),

-- Finished Products (Production Targets - Reorder point 0 as we don't buy them)
('FP001', 'Classic White Bread', 'Fresh white sandwich bread', 12, 10, 'finished_good', 10.000, 100.000, 0.000, 35.00, 65.00, 3, true, true),
('FP002', 'Whole Wheat Bread', 'Healthy whole wheat bread', 12, 10, 'finished_good', 8.000, 80.000, 0.000, 42.00, 75.00, 3, true, true),
('FP003', 'French Baguette', 'Traditional French baguette', 12, 10, 'finished_good', 15.000, 150.000, 0.000, 28.00, 55.00, 1, true, true),
('FP004', 'Croissant', 'Buttery French croissant', 12, 10, 'finished_good', 20.000, 200.000, 0.000, 25.00, 45.00, 2, true, true),
('FP005', 'Chocolate Chip Cookie', 'Classic chocolate chip cookie', 12, 10, 'finished_good', 30.000, 300.000, 0.000, 12.00, 25.00, 7, true, true),
('FP006', 'Blueberry Muffin', 'Fresh blueberry muffin', 12, 10, 'finished_good', 25.000, 250.000, 0.000, 18.00, 35.00, 3, true, true),
('FP007', 'Cheesecake Slice', 'New York style cheesecake', 12, 10, 'finished_good', 12.000, 120.000, 0.000, 45.00, 85.00, 5, true, true),
('FP008', 'Apple Pie', 'Homemade apple pie', 12, 10, 'finished_good', 8.000, 80.000, 0.000, 120.00, 220.00, 4, true, true),
('FP009', 'Cinnamon Roll', 'Cream cheese frosted cinnamon roll', 12, 10, 'finished_good', 18.000, 180.000, 0.000, 22.00, 42.00, 3, true, true),
('FP010', 'Bagel Plain', 'New York style plain bagel', 12, 10, 'finished_good', 15.000, 150.000, 0.000, 15.00, 28.00, 2, true, true),
('FP011', 'Donut Glazed', 'Classic glazed donut', 12, 10, 'finished_good', 25.000, 250.000, 0.000, 10.00, 20.00, 2, true, true),
('FP012', 'Brownie', 'Fudgy chocolate brownie', 12, 10, 'finished_good', 20.000, 200.000, 0.000, 16.00, 30.00, 5, true, true),
('FP013', 'Pandesal', 'Traditional Filipino bread roll', 12, 11, 'finished_good', 50.000, 500.000, 0.000, 5.00, 10.00, 1, true, true),
('FP014', 'Ensaimada', 'Sweet Filipino pastry', 12, 10, 'finished_good', 15.000, 150.000, 0.000, 20.00, 38.00, 3, true, true),
('FP015', 'Pan de Coco', 'Coconut filled bread', 12, 10, 'finished_good', 12.000, 120.000, 0.000, 8.00, 15.00, 2, true, true),

-- Packaging Materials (Critical Supplies - High Reorder)
('PKG001', 'Bread Bag Small', 'Small plastic bread bags', 10, 10, 'supply', 200.000, 2000.000, 500.000, 0.50, 0.00, 0, false, true),
('PKG002', 'Bread Bag Large', 'Large plastic bread bags', 10, 10, 'supply', 150.000, 1500.000, 400.000, 0.75, 0.00, 0, false, true),
('PKG003', 'Pastry Box Small', 'Small pastry boxes', 10, 10, 'supply', 100.000, 1000.000, 300.000, 3.50, 0.00, 0, false, true),
('PKG004', 'Pastry Box Large', 'Large pastry boxes', 10, 10, 'supply', 80.000, 800.000, 250.000, 5.00, 0.00, 0, false, true),
('PKG005', 'Cake Box', 'Specialty cake boxes', 10, 10, 'supply', 50.000, 500.000, 150.000, 8.00, 0.00, 0, false, true),
('PKG006', 'Paper Bag', 'Brown paper bags', 10, 10, 'supply', 300.000, 3000.000, 800.000, 1.20, 0.00, 0, false, true),

-- Cleaning Supplies
('CLN001', 'Food Safe Sanitizer', 'Food contact surface sanitizer', 11, 5, 'supply', 5.000, 50.000, 15.000, 180.00, 0.00, 0, false, true),
('CLN002', 'Floor Cleaner', 'Industrial floor cleaner', 11, 5, 'supply', 3.000, 30.000, 10.000, 220.00, 0.00, 0, false, true),
('CLN003', 'Dish Soap', 'Food safe dish soap', 11, 5, 'supply', 8.000, 80.000, 25.000, 95.00, 0.00, 0, false, true),
('CLN004', 'Hand Soap', 'Antibacterial hand soap', 11, 5, 'supply', 6.000, 60.000, 20.000, 120.00, 0.00, 0, false, true),
('CLN005', 'Disposable Gloves', 'Food service disposable gloves', 11, 12, 'supply', 10.000, 100.000, 30.000, 350.00, 0.00, 0, false, true),

-- Chocolate Products (Medium Volume)
('CHC001', 'Cocoa Powder', 'Natural unsweetened cocoa powder', 16, 1, 'raw_material', 5.000, 50.000, 15.000, 280.00, 0.00, 365, true, true),
('CHC002', 'Dark Chocolate', '70% dark chocolate bars', 16, 1, 'raw_material', 8.000, 80.000, 25.000, 320.00, 0.00, 180, true, true),
('CHC003', 'Milk Chocolate', 'Milk chocolate bars', 16, 1, 'raw_material', 10.000, 100.000, 30.000, 290.00, 0.00, 180, true, true),
('CHC004', 'White Chocolate', 'Premium white chocolate', 16, 1, 'raw_material', 6.000, 60.000, 20.000, 310.00, 0.00, 180, true, true),
('CHC005', 'Chocolate Chips', 'Semi-sweet chocolate chips', 16, 1, 'raw_material', 12.000, 120.000, 40.000, 350.00, 0.00, 365, true, true),
('CHC006', 'Chocolate Syrup', 'Chocolate syrup for drinks', 16, 5, 'raw_material', 4.000, 40.000, 12.000, 180.00, 0.00, 365, true, true),
('CHC007', 'Cocoa Butter', 'Pure cocoa butter', 16, 1, 'raw_material', 3.000, 30.000, 10.000, 420.00, 0.00, 365, true, true),
('CHC008', 'Chocolate Sprinkles', 'Colorful chocolate sprinkles', 16, 1, 'raw_material', 8.000, 80.000, 25.000, 240.00, 0.00, 365, true, true),

-- Eggs & Egg Products (Very High Volume - Fast Turnaround)
('EGG001', 'Fresh Eggs', 'Large fresh eggs', 17, 10, 'raw_material', 60.000, 600.000, 150.000, 12.00, 0.00, 21, true, true),
('EGG002', 'Egg Whites', 'Pasteurized egg whites', 17, 5, 'raw_material', 10.000, 100.000, 30.000, 150.00, 0.00, 30, true, true),
('EGG003', 'Egg Yolks', 'Pasteurized egg yolks', 17, 5, 'raw_material', 8.000, 80.000, 25.000, 180.00, 0.00, 30, true, true),
('EGG004', 'Whole Egg Powder', 'Spray dried whole egg powder', 17, 1, 'raw_material', 5.000, 50.000, 15.000, 380.00, 0.00, 365, true, true),
('EGG005', 'Egg White Powder', 'Spray dried egg white powder', 17, 1, 'raw_material', 4.000, 40.000, 12.000, 450.00, 0.00, 365, true, true),
('EGG006', 'Liquid Eggs', 'Pasteurized liquid whole eggs', 17, 5, 'raw_material', 15.000, 150.000, 45.000, 120.00, 0.00, 14, true, true),

-- Nuts & Dried Fruits
('NUT001', 'Almonds Whole', 'Raw whole almonds', 18, 1, 'raw_material', 8.000, 80.000, 25.000, 480.00, 0.00, 180, true, true),
('NUT002', 'Walnuts Pieces', 'Walnut pieces', 18, 1, 'raw_material', 6.000, 60.000, 20.000, 420.00, 0.00, 180, true, true),
('NUT003', 'Cashews Raw', 'Raw cashew nuts', 18, 1, 'raw_material', 5.000, 50.000, 15.000, 520.00, 0.00, 180, true, true),
('NUT004', 'Pecans Halves', 'Pecan halves', 18, 1, 'raw_material', 4.000, 40.000, 12.000, 580.00, 0.00, 180, true, true),
('NUT005', 'Hazelnuts', 'Whole hazelnuts', 18, 1, 'raw_material', 5.000, 50.000, 15.000, 460.00, 0.00, 180, true, true),
('NUT006', 'Raisins', 'Thompson seedless raisins', 18, 1, 'raw_material', 10.000, 100.000, 30.000, 120.00, 0.00, 365, true, true),
('NUT007', 'Dried Cranberries', 'Sweetened dried cranberries', 18, 1, 'raw_material', 8.000, 80.000, 25.000, 180.00, 0.00, 365, true, true),
('NUT008', 'Dates', 'Medjool dates', 18, 1, 'raw_material', 6.000, 60.000, 20.000, 320.00, 0.00, 365, true, true),
('NUT009', 'Apricots Dried', 'Dried apricots', 18, 1, 'raw_material', 7.000, 70.000, 25.000, 240.00, 0.00, 365, true, true),
('NUT010', 'Prunes', 'Pitted prunes', 18, 1, 'raw_material', 5.000, 50.000, 15.000, 190.00, 0.00, 365, true, true),

-- Food Colors & Flavors (Low Volume)
('FCF001', 'Vanilla Extract', 'Pure vanilla extract', 19, 5, 'raw_material', 2.000, 20.000, 6.000, 850.00, 0.00, 730, true, true),
('FCF002', 'Almond Extract', 'Pure almond extract', 19, 5, 'raw_material', 1.000, 10.000, 3.000, 780.00, 0.00, 730, true, true),
('FCF003', 'Lemon Extract', 'Natural lemon extract', 19, 5, 'raw_material', 1.000, 10.000, 3.000, 720.00, 0.00, 730, true, true),
('FCF004', 'Red Food Color', 'Liquid red food color', 19, 5, 'raw_material', 3.000, 30.000, 10.000, 150.00, 0.00, 365, true, true),
('FCF005', 'Blue Food Color', 'Liquid blue food color', 19, 5, 'raw_material', 3.000, 30.000, 10.000, 150.00, 0.00, 365, true, true),
('FCF006', 'Green Food Color', 'Liquid green food color', 19, 5, 'raw_material', 3.000, 30.000, 10.000, 150.00, 0.00, 365, true, true),
('FCF007', 'Yellow Food Color', 'Liquid yellow food color', 19, 5, 'raw_material', 3.000, 30.000, 10.000, 150.00, 0.00, 365, true, true),
('FCF008', 'Butter Flavor', 'Natural butter flavor', 19, 5, 'raw_material', 2.000, 20.000, 6.000, 380.00, 0.00, 365, true, true),

-- Decorations & Toppings
('DEC001', 'Rainbow Sprinkles', 'Colorful rainbow sprinkles', 20, 1, 'raw_material', 8.000, 80.000, 25.000, 120.00, 0.00, 365, true, true),
('DEC002', 'Chocolate Sprinkles', 'Chocolate jimmies', 20, 1, 'raw_material', 8.000, 80.000, 25.000, 110.00, 0.00, 365, true, true),
('DEC003', 'Fondant', 'Rolled fondant icing', 20, 1, 'raw_material', 5.000, 50.000, 15.000, 280.00, 0.00, 180, true, true),
('DEC004', 'Royal Icing', 'Royal icing mix', 20, 1, 'raw_material', 4.000, 40.000, 12.000, 320.00, 0.00, 365, true, true),
('DEC005', 'Edible Glitter', 'Gold edible glitter', 20, 1, 'raw_material', 2.000, 20.000, 6.000, 450.00, 0.00, 365, true, true),
('DEC006', 'Pearl Dust', 'Edible pearl dust', 20, 1, 'raw_material', 1.000, 10.000, 3.000, 520.00, 0.00, 365, true, true),
('DEC007', 'Candy Eyes', 'Edible candy eyes', 20, 10, 'raw_material', 10.000, 100.000, 30.000, 85.00, 0.00, 365, true, true),
('DEC008', 'Sugar Flowers', 'Edible sugar flowers', 20, 10, 'raw_material', 5.000, 50.000, 15.000, 180.00, 0.00, 365, true, true),

-- Yeast & Fermentation
('YST001', 'Active Dry Yeast', 'Active dry yeast packets', 21, 1, 'raw_material', 10.000, 100.000, 30.000, 45.00, 0.00, 365, true, true),
('YST002', 'Instant Yeast', 'Instant yeast', 21, 1, 'raw_material', 8.000, 80.000, 25.000, 50.00, 0.00, 365, true, true),
('YST003', 'Fresh Yeast', 'Compressed fresh yeast', 21, 1, 'raw_material', 5.000, 50.000, 15.000, 35.00, 0.00, 14, true, true),
('YST004', 'Sourdough Starter', 'Active sourdough starter', 21, 1, 'raw_material', 2.000, 20.000, 6.000, 25.00, 0.00, 7, true, true),
('YST005', 'Yeast Nutrient', 'Yeast nutrient powder', 21, 1, 'raw_material', 1.000, 10.000, 3.000, 120.00, 0.00, 365, true, true),

-- Salt & Seasonings
('SLT001', 'Table Salt', 'Fine table salt', 22, 1, 'raw_material', 10.000, 100.000, 30.000, 15.00, 0.00, 0, false, true),
('SLT002', 'Sea Salt', 'Coarse sea salt', 22, 1, 'raw_material', 5.000, 50.000, 15.000, 25.00, 0.00, 0, false, true),
('SLT003', 'Himalayan Salt', 'Pink Himalayan salt', 22, 1, 'raw_material', 3.000, 30.000, 10.000, 45.00, 0.00, 0, false, true),
('SLT004', 'Cinnamon Ground', 'Ground cinnamon', 22, 1, 'raw_material', 4.000, 40.000, 12.000, 180.00, 0.00, 365, true, true),
('SLT005', 'Nutmeg Ground', 'Ground nutmeg', 22, 1, 'raw_material', 2.000, 20.000, 6.000, 220.00, 0.00, 365, true, true),
('SLT006', 'Allspice', 'Ground allspice', 22, 1, 'raw_material', 2.000, 20.000, 6.000, 190.00, 0.00, 365, true, true),

-- Additional Items
('FLR011', 'Cake Flour Extra', 'Extra fine cake flour for delicate pastries', 1, 1, 'raw_material', 0.000, 50.000, 10.000, 52.00, 0.00, 365, true, true),
('DRY009', 'Sour Cream', 'Cultured sour cream', 2, 5, 'raw_material', 0.000, 30.000, 5.000, 85.00, 0.00, 14, true, true),
('SWT007', 'Agave Syrup', 'Natural agave sweetener', 3, 5, 'raw_material', 0.000, 25.000, 5.000, 320.00, 0.00, 365, true, true),
('CHC009', 'Single Origin Chocolate', 'Premium single origin chocolate', 16, 1, 'raw_material', 1.000, 20.000, 5.000, 850.00, 0.00, 180, true, true),
('NUT011', 'Macadamia Nuts', 'Premium macadamia nuts', 18, 1, 'raw_material', 2.000, 30.000, 6.000, 1200.00, 0.00, 180, true, true),
('DEC009', 'Gold Leaf', 'Edible gold leaf decoration', 20, 1, 'raw_material', 0.100, 5.000, 0.500, 2500.00, 0.00, 1095, true, true),
('FLR012', 'Bulk Flour Mix', 'Economy bulk flour blend', 1, 1, 'raw_material', 100.000, 2000.000, 300.000, 38.00, 0.00, 365, true, true),
('SWT008', 'Bulk Sugar', 'Industrial grade sugar', 3, 1, 'raw_material', 200.000, 5000.000, 600.000, 48.00, 0.00, 730, true, true),
('PKG007', 'Bulk Packaging', 'Bulk packaging materials', 10, 12, 'supply', 500.000, 10000.000, 1500.000, 0.25, 0.00, 0, false, true),
('FCF009', 'Truffle Oil', 'Black truffle oil', 19, 5, 'raw_material', 0.500, 10.000, 2.000, 1800.00, 0.00, 365, true, true),
('YST006', 'Sourdough Culture', 'Artisan sourdough culture', 21, 1, 'raw_material', 0.500, 5.000, 1.500, 150.00, 0.00, 30, true, true),
('DEC010', 'Caviar Pearls', 'Edible caviar pearls', 20, 1, 'raw_material', 0.200, 3.000, 1.000, 3200.00, 0.00, 180, true, true),
('DRY010', 'Fresh Cream Cheese', 'Ultra-fresh cream cheese', 2, 1, 'raw_material', 5.000, 50.000, 15.000, 380.00, 0.00, 7, true, true),
('EGG007', 'Duck Eggs', 'Premium duck eggs', 17, 10, 'raw_material', 10.000, 100.000, 30.000, 25.00, 0.00, 14, true, true),
('FRT001', 'Fresh Strawberries', 'Premium strawberries', 8, 1, 'raw_material', 2.000, 20.000, 6.000, 450.00, 0.00, 3, true, true),
('SLT007', 'Rock Salt', 'Industrial rock salt', 22, 1, 'raw_material', 20.000, 200.000, 60.000, 8.00, 0.00, 0, false, true),
('CLN006', 'Industrial Cleaner', 'Heavy duty industrial cleaner', 11, 5, 'supply', 5.000, 100.000, 15.000, 450.00, 0.00, 0, false, true),
('FP016', 'Gluten-Free Bread', 'Premium gluten-free bread', 12, 10, 'finished_good', 8.000, 80.000, 0.000, 55.00, 95.00, 3, true, true),
('FP017', 'Vegan Cupcake', 'Plant-based vegan cupcake', 12, 10, 'finished_good', 15.000, 150.000, 0.000, 22.00, 42.00, 2, true, true),
('FP018', 'Sugar-Free Cookie', 'Diabetic-friendly sugar cookie', 12, 10, 'finished_good', 20.000, 200.000, 0.000, 18.00, 35.00, 7, true, true),
('FP019', 'Organic Muffin', 'Certified organic muffin', 12, 10, 'finished_good', 12.000, 120.000, 0.000, 28.00, 52.00, 3, true, true),
('FP020', 'Artisan Sourdough', 'Traditional sourdough bread', 12, 10, 'finished_good', 10.000, 100.000, 0.000, 65.00, 120.00, 4, true, true),
('EQP001', 'Digital Scale', 'Precision digital scale', 13, 1, 'supply', 1.000, 10.000, 3.000, 2500.00, 0.00, 0, false, true),
('EQP002', 'Mixing Bowl Set', 'Stainless steel mixing bowl set', 13, 10, 'supply', 2.000, 20.000, 5.000, 850.00, 0.00, 0, false, true),
('EQP003', 'Baking Sheets', 'Commercial baking sheets', 13, 10, 'supply', 5.000, 50.000, 15.000, 180.00, 0.00, 0, false, true),
('BEV001', 'Coffee Beans', 'Premium Arabica coffee beans', 14, 1, 'supply', 5.000, 50.000, 15.000, 680.00, 0.00, 365, true, true),
('BEV002', 'Tea Selection', 'Premium tea selection', 14, 12, 'supply', 3.000, 30.000, 10.000, 420.00, 0.00, 730, true, true),
('BEV003', 'Juice Concentrate', 'Natural juice concentrate', 14, 5, 'supply', 4.000, 40.000, 12.000, 280.00, 0.00, 365, true, true),
('FRZ001', 'Frozen Berries', 'Mixed frozen berries', 15, 1, 'raw_material', 10.000, 100.000, 30.000, 180.00, 0.00, 365, true, true),
('FRZ002', 'Frozen Dough', 'Pre-made frozen dough', 15, 1, 'raw_material', 8.000, 80.000, 25.000, 95.00, 0.00, 180, true, true),
('FRZ003', 'Frozen Vegetables', 'Mixed frozen vegetables', 15, 1, 'raw_material', 6.000, 60.000, 20.000, 120.00, 0.00, 365, true, true),
('INACTIVE001', 'Discontinued Flour', 'No longer used flour type', 1, 1, 'raw_material', 0.000, 0.000, 0.000, 45.00, 0.00, 365, true, false),
('INACTIVE002', 'Outdated Supply', 'Discontinued supply item', 11, 5, 'supply', 0.000, 0.000, 0.000, 120.00, 0.00, 0, false, false),
('DRY011', 'Soft Cheese', 'Soft-ripened cheese', 2, 1, 'raw_material', 2.000, 20.000, 6.000, 450.00, 0.00, 3, true, true),
('FRT002', 'Fresh Basil', 'Fresh basil leaves', 8, 1, 'raw_material', 1.000, 10.000, 3.000, 800.00, 0.00, 1, true, true),
('YOG001', 'Live Culture Yogurt', 'Probiotic yogurt culture', 2, 5, 'raw_material', 3.000, 30.000, 10.000, 320.00, 0.00, 5, true, true);

...
<body class="antialiased body-pattern font-sans text-text-dark">
    ...
    <div class="flex items-center justify-center min-h-screen p-4 sm:p-8">
        <div
            class="flex w-full max-w-6xl overflow-hidden shadow-[0_20px_50px_rgba(61,40,23,0.15)] border border-border-soft bg-white rounded-2xl">

            <div class="hidden md:block w-5/12 bg-chocolate relative overflow-hidden">
                <div
                    class="absolute inset-0 bg-gradient-to-br from-chocolate via-[#4a3221] to-chocolate-dark opacity-90">
                </div>
                ...
                <div class="relative flex flex-col justify-between h-full p-12 text-white z-10">
                    <div>
                        <div class="flex items-center space-x-3 mb-6">
                            <div
                                class="w-12 h-12 bg-caramel/20 backdrop-blur-sm flex items-center justify-center border border-caramel/30 rounded-lg">
                                <i class="fas fa-birthday-cake text-caramel text-xl"></i>
                            </div>
                            <div>
                                <h1 class="font-display text-2xl font-bold tracking-wide">
                                    {{ config('app.name', 'WellKenz') }}</h1>
                    ...
                    <div>
                        <h2 class="font-display text-4xl font-bold leading-tight mb-4">
                            WellKenz Cakeshop
                            Resource Management <br /><span class="gradient-text">System</span>
                        </h2>
            ...
            <div class="w-full md:w-7/12 bg-white p-8 sm:p-12 lg:p-16">
                ...
                <form method="POST" action="{{ route('login.post') }}" class="space-y-6" id="loginForm">
                    ...
                    <div>
                        <label for="email"
                            class="block text-xs font-bold text-text-dark uppercase tracking-wider mb-2">
                            Email Address
                        </label>
                        <div class="relative group">
                            <div
                                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-chocolate">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email') }}" required
                                ...
                                placeholder="name@wellkenz.com" autocomplete="email" autofocus>
                        </div>
                        @error('email')
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label for="password"
                                class="block text-xs font-bold text-text-dark uppercase tracking-wider">
                                Password
                            </label>
                        </div>
                        <div class="relative group">
                            ...
                            <button type="button"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-text-muted hover:text-chocolate transition-colors cursor-pointer focus:outline-none"
                    ...
                    <div class="pt-2">
                        <button type="submit" id="submitBtn"
                            ...
                            <span>Sign In</span>
                            <i
                                class="fas fa-arrow-right ml-2 opacity-80 group-hover:translate-x-1 transition-transform"></i>
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-8 pt-6 border-t border-border-soft text-center">
                    <p class="text-xs text-text-muted">
                        ...
                        <a href="mailto:support@wellkenz.com"
                            class="font-bold text-chocolate hover:underline mt-1 inline-block">
                            Contact IT Support
                        </a>
                    </p>
                </div>

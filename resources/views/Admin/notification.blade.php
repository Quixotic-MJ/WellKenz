    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Stay updated with system alerts and activity.</p>
            </div>
        ...
        @empty
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-12 text-center shadow-sm">
                ...
                <p class="text-gray-500 mt-1">
                    ...
                    @else
                        No {{ $filter }} notifications found. <a href="{{ route('admin.notifications.index') }}" class="text-chocolate hover:underline">View all</a>.
                    @endif
                </p>
            </div>
        @endforelse

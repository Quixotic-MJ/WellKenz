    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Stay updated with inventory alerts and system messages.</p>
            </div>
            ...
            <div class="text-center py-12">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-sm text-gray-500 text-center max-w-sm">
                        @if($filter === 'all')
                            You don't have any notifications yet. You'll receive updates about inventory alerts, requisitions, and system messages here.
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setActiveMenu('menu-inventory-notifications');
    ...
    document.querySelectorAll('.notification-item').forEach(item => {
        ...
        if (markReadUnreadBtn) {
            markReadUnreadBtn.addEventListener('click', function() {
                ...
                // Actual API call
                fetch(`{{ route('inventory.notifications') }}/${notificationId}/mark-${action}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        'Content-Type': 'application/json',

    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Alerts on deliveries, issuances, stock & expiry – mark as read when done</p>
            </div>
                    ...
                    <tr class="hover:bg-gray-50 transition notif-row cursor-pointer"
                        ...
                        <td class="px-6 py-4" onclick="event.stopPropagation()">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('inventory.notifications.jump',$n->notification_id) }}"
...
<!-- ====== VIEW MODAL  ====== -->
@include('Inventory.Notifications.modals.view')
...
function openViewModal(id){
    ...
    .then(res=>{
        ...
        if(!res.is_read) fetch(`/inventory/notifications/${id}/mark-read`,{method:'POST',headers:{'X-CSRF-TOKEN':'{{ csrf_token() }}'}});
    })

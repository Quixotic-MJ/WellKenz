    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <form id="itemRequestForm" class="space-y-6">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Be specific about the item specifications to help with procurement</p>
            </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-600 mt-1">
                            Your request will be reviewed by supervisors. Once approved, the item will be added to the inventory 
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-200">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Date Requested</th>

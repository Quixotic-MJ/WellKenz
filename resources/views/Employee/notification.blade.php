...
<div class="w-full px-4 sm:px-6 lg:px-8 space-y-8 pb-24 font-sans text-gray-600 relative">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
            ...
            <p class="text-sm text-gray-500">Stay updated with production alerts, approvals, and system messages.</p>
        </div>
        <div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        if (deleteBtn) {
            deleteBtn.addEventListener('click', function() {
                openConfirmModal('Delete Notification', 'This action cannot be undone.', function() {
                    // Simulated Deletion for demo logic or real logic if route exists
                    // Assuming standard resource route
                    // fetch(...) logic here
    ...
    function performBulk(operation) {
        ...
        openConfirmModal(title, msg, function() {
            ...
            setTimeout(() => {
                showToast('Success', `${selectedIds.length} notifications updated`);
                if (operation === 'delete') {

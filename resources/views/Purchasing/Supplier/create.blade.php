<div id="createSupModal" class="hidden fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div class="relative z-10 bg-white w-full max-w-lg rounded shadow-lg" onclick="event.stopPropagation()">
        <div class="px-5 py-3 border-b flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-900">Create New Supplier</h3>
            <button onclick="closeModals()" class="text-gray-500 hover:text-gray-700"><i class="fas fa-times"></i></button>
        </div>
        <form id="createSupForm" class="p-5 space-y-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <select name="sup_status" class="mt-1 w-full border border-gray-300 rounded px-3 py-2 text-sm">
        ...
        <div class="px-5 py-3 border-t bg-gray-50 text-right">
            ...
            <button id="createSupSaveBtn" class="px-4 py-2 bg-blue-600 text-white rounded">Create</button>
        </div>
    </div>
</div>
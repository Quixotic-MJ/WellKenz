<div id="approveRequisitionModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    <div class="bg-white max-w-md w-full rounded-lg border border-gray-200">
        <form method="POST" action="">@csrf
            ...
            <div class="p-6 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Approve Requisition</h3>
                <button type="button" onclick="closeModals()" class="text-gray-500 hover:text-gray-700"><i class="fas fa-times"></i></button>
            </div>
            <div class="p-6">
                <p class="text-sm text-gray-700 mb-2">Approve requisition <span id="approveRequisitionRef" class="font-semibold"></span>?</p>
                <p class="text-xs text-gray-500">This will notify the employee and the purchasing officer.</p>
            </div>

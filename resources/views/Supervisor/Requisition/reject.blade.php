<div id="rejectRequisitionModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    <div class="bg-white max-w-md w-full rounded-lg border border-gray-200">
        <form method="POST" action="">@csrf
            ...
            <div class="p-6 space-y-4">
                <p class="text-sm text-gray-700">Reject requisition <span id="rejectRequisitionRef" class="font-semibold"></span>?</p>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Reason (stored in req_reject_reason)</label>
                    <textarea name="req_reject_reason" rows="4" required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-gray-400"></textarea>
                </div>

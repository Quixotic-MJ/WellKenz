<div id="notificationDetailModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    <div class="bg-white max-w-2xl w-full rounded-lg border border-gray-200">
        ...
        <div class="p-6 space-y-3 text-sm" id="notificationDetailBody">
            {{-- ajax populates: title, content, related link, timestamp --}}
        </div>

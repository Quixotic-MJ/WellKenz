    ...
    <div class="space-y-6">
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Welcome to your {{ session('role') }} dashboard - Bakery Performance Overview</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-5">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-gray-900 mt-2">$12,458</p>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-5">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs text-gray-500 uppercase tracking-wider">Stock Value</p>
                        <p class="text-2xl font-semibold text-gray-900 mt-2">$8,742</p>
                        <p class="text-xs text-gray-400 mt-1">Current inventory</p>
                    </div>
                    <div class="w-10 h-10 bg-gray-100 flex items-center justify-center rounded">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900 font-medium">New flour requisition created</p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900 font-medium">Sugar purchase approved</p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900 font-medium">Butter stock updated</p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900 font-medium">Low stock - chocolate chips</p>
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div class="space-y-3">
                    <div class="p-4 border-l-4 border-red-500 bg-red-50 rounded">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Category: Raw Materials</p>
                    </div>
